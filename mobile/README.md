...
- `shared`: common runtime kernel source set with baseline runtime identity metadata, package networking contracts, secure token storage contracts, package response serialization DTOs, package local store contracts, and package downloader orchestration.
