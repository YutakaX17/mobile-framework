...
- Backend validation runs Django system checks, migration checks, the core health endpoint test, tenant model tests, identity/RBAC model tests, module registry tests, and configuration registry tests.
