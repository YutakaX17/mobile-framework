...
- Backend validation runs Django system checks, migration checks, core health endpoint and service lifecycle tests, tenant model tests, identity/RBAC model tests, module registry tests, configuration registry tests, and audit event model tests.
