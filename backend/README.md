...
- `apps/deployment_packages`: initial tenant-scoped package model, compiler, signing, hash verification, release channel, activation, rollback, and mobile manifest endpoint baseline.
...
- `apps/deployment_packages`: immutable package compilation, signing, channels, rollback. Initial package model, compiler, signing, hash verification, release channel, activation, rollback, and mobile manifest endpoint baselines exist.
