...
- `apps/deployment_packages`: initial tenant-scoped package model, compiler, signing, hash verification, release channel, activation, and rollback baseline.
...
- `apps/deployment_packages`: immutable package compilation, signing, channels, rollback. Initial package model, compiler, signing, hash verification, release channel, activation, and rollback baselines exist.
