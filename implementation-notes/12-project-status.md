...
- `[~]` EPIC-09 Deployment Packages: package model, compiler, signing, and hash verification baselines are complete; release channels, activation, rollback, mobile manifest endpoint, package download endpoint, and audit events remain pending.
