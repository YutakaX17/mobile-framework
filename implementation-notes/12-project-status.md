...
- `[~]` EPIC-09 Deployment Packages: package model, compiler, signing, hash verification, and release channel baselines are complete; activation, rollback, mobile manifest endpoint, package download endpoint, and audit events remain pending.
