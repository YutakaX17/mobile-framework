...
- `[~]` EPIC-03 Rust Extension: initial Rust extension scaffold, JSON canonicalization helper, config/package JSON hash helpers, and app definition diff helper are complete; sync merge helper remains pending.
