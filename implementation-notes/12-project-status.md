...
- `[~]` EPIC-09 Deployment Packages: package model, compiler, signing, hash verification, release channel, activation, and rollback baselines are complete; mobile manifest endpoint, package download endpoint, and audit events remain pending.
