...
- `[~]` EPIC-03 Rust Extension: initial Rust extension scaffold and JSON canonicalization helper are complete; hashing, diff, and sync merge helpers remain pending.
