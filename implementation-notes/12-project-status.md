...
- `[~]` EPIC-09 Deployment Packages: package model, compiler, signing, hash verification, release channel, and activation baselines are complete; rollback, mobile manifest endpoint, package download endpoint, and audit events remain pending.
