...
- `[~]` EPIC-04 Shared Contracts: initial schema/fixture/validation-runner batch and generated TypeScript/Python/Kotlin declarations are complete; future schema expansion remains pending.
