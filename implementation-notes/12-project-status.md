...
- `[~]` EPIC-10 Mobile Runtime: KMP project scaffold and shared Compose module baselines are complete; networking, serialization, local store, secure storage, package downloader, verifier, renderers, offline outbox, sync engine, and mobile tests remain pending.
