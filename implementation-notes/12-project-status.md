...
- `[~]` EPIC-09 Deployment Packages: package model, compiler, and signing baselines are complete; hash verification, release channels, activation, rollback, mobile manifest endpoint, package download endpoint, and audit events remain pending.
