...
- `[~]` EPIC-08 App And Screen Builder: app definition model/API, app list page, screen builder canvas, component registry, component property editor, navigation model/schema, screen model/schema, and action binding baselines are complete; permission binding, mobile preview, app validation, and publish draft flow remain pending.
