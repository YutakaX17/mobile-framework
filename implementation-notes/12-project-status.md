...
- `[~]` EPIC-10 Mobile Runtime: KMP project scaffold, shared Compose module, networking contract, and serialization baselines are complete; local store, secure storage, package downloader, verifier, renderers, offline outbox, sync engine, and mobile tests remain pending.
