...
- `[~]` EPIC-03 Rust Extension: initial Rust extension scaffold, JSON canonicalization helper, config JSON hash helper, and package JSON hash helper are complete; diff and sync merge helpers remain pending.
