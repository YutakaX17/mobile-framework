...
- `[~]` EPIC-03 Rust Extension: initial Rust extension scaffold, JSON canonicalization helper, and config JSON hash helper are complete; package hashing, diff, and sync merge helpers remain pending.
