...
- `[~]` EPIC-12 CI/CD, Security, And Release: Python, Rust, frontend lint/test/build, mobile Gradle test, contract test, Playwright E2E, dependency scan, CodeQL, secret scanning, and Docker build workflow baselines are complete; SBOM generation remains pending.
