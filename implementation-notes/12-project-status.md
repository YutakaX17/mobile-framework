...
- `[~]` EPIC-05 Admin Frontend Shell: initial Vite React TypeScript scaffold and routing foundation are complete; auth shell, API client, module registry, and design system foundation remain pending.
