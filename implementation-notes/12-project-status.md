...
- `[~]` EPIC-08 App And Screen Builder: app definition model/API baseline is complete; navigation model/schema, screen model/schema, component registry, builder canvas, property editors, action binding, permission binding, mobile preview, app validation, and publish draft flow remain pending.
