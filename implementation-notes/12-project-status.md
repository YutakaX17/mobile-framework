...
- `[~]` EPIC-12 CI/CD, Security, And Release: Python, Rust, frontend lint/test/build, mobile Gradle test, contract test, Playwright E2E, dependency scan, CodeQL, secret scanning, Docker build, and SBOM generation workflow baselines are complete; image signing remains pending.
