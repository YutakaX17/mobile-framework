...
- `[~]` EPIC-08 App And Screen Builder: app definition model/API, app list page, screen builder canvas, component registry, and component property editor baselines are complete; navigation model/schema, screen model/schema, action binding, permission binding, mobile preview, app validation, and publish draft flow remain pending.
