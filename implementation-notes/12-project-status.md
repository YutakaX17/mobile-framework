...
- `[~]` EPIC-12 CI/CD, Security, And Release: Python, Rust, frontend lint/test/build, mobile Gradle test, contract test, and Playwright E2E workflow baselines are complete; dependency scan workflow remains pending.
