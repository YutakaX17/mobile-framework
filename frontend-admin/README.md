...
The `/forms` workspace renders the initial read-only form list page backed by `src/api/formApi.ts`. `/forms/:formId` renders the first form designer baseline with field toolbox and canvas inspection.
